        ...
        >
          ...
          {isSold && (
            <>
              ...
              <div className="rounded-xl px-3 mb-4" style={{ border: "1px solid #e2e8f0" }}>
                ...
                {entry.sold_at && (
                  <InfoRow label="Sold On" value={formatDate(entry.sold_at)} />
                )}
                <InfoRow
                  label="Original Qty"
              ...
              <div
                className="rounded-xl px-3 py-3 flex items-start gap-2 mb-4"
          ...
          {!isSold && (
            <>
              ...
              <p className="text-base font-bold text-[#0f172a] leading-snug mb-3">
                {entry.description}
              </p>
              ...
              <div className="rounded-xl px-3 mb-4" style={{ border: "1px solid #e2e8f0" }}>
                ...
                <InfoRow
                  label="Qty"
                  value={`${entry.quantity}${entry.uom ? ` ${entry.uom}` : ""}`}
                />
